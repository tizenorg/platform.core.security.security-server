...
{
    switch (path_type) {
        case SECURITY_MANAGER_FILE_PRIVATE:
            lpc_path_type = APP_PATH_PRIVATE;
            break;
        case SECURITY_MANAGER_FILE_PUBLIC:
            lpc_path_type = APP_PATH_GROUP_RW;
            break;
        case SECURITY_MANAGER_FILE_PUBLIC_RO:
            lpc_path_type = APP_PATH_PUBLIC_RO;
            break;
        default:
            return false;
    };
