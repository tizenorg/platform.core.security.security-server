...
bool generate_app_label(const std::string appPkgId, std::string& label)
{
    (void) appPkgId; //todo use pkgId to generate label
    label.assign(LABEL_FOR_PUBLIC_APP_PATH);//temprorarily label all private dirs with public label
    return true;
}
