 ...
 * @version     1.0
 */
#ifndef SECURITY_SERVER_STRING
#define SECURITY_SERVER_STRING
...
//!\brief convert ASCII string to SecurityServer::String
String FromASCIIString(const std::string& aString);

//!\brief convert UTF32 string to SecurityServer::String
...
std::ostream& operator<<(std::ostream& aStream, const SecurityServer::String& aString);

#endif // SECURITY_SERVER_STRING
